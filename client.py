...
class Main:
    ...
    class UI:
            ...
            def banner(self):
                print(Align("""
[purple]   ____     ___    [/purple][red]   _______        __ [/red]
[purple]  / __/__ _/ _/_ __[/purple][red]  / ___/ /  ___ _/ /_[/red]
[purple] _\ \/ _ `/ _/ // /[/purple][red] / /__/ _ \/ _ `/ __/[/red]
[purple]/___/\_,_/_/ \_, / [/purple][red] \___/_//_/\_,_/\__/ [/red]
[purple]            /___/  [/purple]                       
                ""","center"))
            def get_server(self):
    ...
    def connect(self):
        ...
        private_key = zlib.decompress(s.recv(1024))
        public_key = zlib.decompress(s.recv(1024))
        ...
        cls()
        print(Align(self.chat_sock.recv(1024),"center"))
    ...
    def chat(self):
        def receive():
            while True:
                print(self.chat_sock.recv(1024))
        def write():
            while True:
                msg = input()
